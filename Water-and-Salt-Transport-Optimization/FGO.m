...
function [Gb_Fit,Gb_Sol,Conv_curve]=FGO(fhd,lb,ub,dim,N,Tmax)
    %%%%-------------------Definitions--------------------------%%
    %%
    ...
    for i=1:N
        ...
        fit(i) = fhd(S(i,:)'); % Calculate the fitness value of the ith hyphal
    end
    ...
    disp(['FGO: The best fitness is ', num2str(Gb_Fit)]);
    end
