...
function [best_Bee,bestBee_Position,bestfitIter] = ABC(ObjFun,LB,UB,nVar,nPop,MaxIt)
    %% Problem Parameters
    ...
    for q = 1:cPop
        ...
        fit(q) = CalFit(f(q));  % evaluating the fitness fun value
         ...
         % vector to store best fitness value of the 0th iteration 
    ...
    for t = 1:Maxiter
        ...
        bestfitIter(t) = bestobj;
        disp(['Iteration ' num2str(t) ': Best Cost = ' num2str(bestfitIter(t))]);
    end
