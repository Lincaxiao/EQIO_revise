...
function [best_Particle,bestParticle_Position,bestfitIter] = PSO(ObjFun,LB,UB,nVar,nPop,MaxIt)
    %% Problem Parameters
    ...
    for t = 1:Maxiter
        ...
        bestfitIter(t) = f_gbest;
        disp(['PSO Iteration ' num2str(t) ': Best fitness = ' num2str(f_gbest)]);
    end
