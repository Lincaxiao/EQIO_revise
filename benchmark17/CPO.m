...
%  Paper:
%  Zhiqing GUO, Guangwei LIU, and Feng JIANG
%  Chinese Pangolin Optimizer: A novel bio-inspired metaheuristic ...
%  for solving  optimization problems
%__________________________________________________________________

function [Manis_score,Manis_pos,Convergence_curve]=CPO(fobj,lb,ub,dim,SearchAgents_no,Max_iter)
...
disp(['CPO: The best score is: ', num2str(Manis_score)]);
end
...
function Bs=Aroma_trajectory(N,Dc)
    ...
    randn('seed',sum(10*clock))
    randomIndex = randi(N);
    randomPointx = x(:, randomIndex);
